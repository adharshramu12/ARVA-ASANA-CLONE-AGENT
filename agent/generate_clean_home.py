...
def generate_clean_home():
    """Generate clean Home.jsx with exact structure specified"""
    print("[INFO] Loading home.json...")
    
    # Use relative path from script location
    script_dir = os.path.dirname(os.path.abspath(__file__))
    json_path = os.path.join(script_dir, "extracted", "home.json")
    ...
    # Create the Home.jsx file with exact structure specified
...
const SafeLargeUI = dynamic(() => Promise.resolve(HomeGeneratedContent), {{
  ssr: false,
}});
...
"""
    ...
    # Write to file
    output_path = os.path.join(script_dir, "..", "frontend", "generated", "Home.jsx")
